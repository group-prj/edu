      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 "><img src="img/login.jpeg" width="500" height="500"></div>
              <div class="col-lg-6">
                <div class="p-5">
                ...
                if(isset($_REQUEST['status']))
                  {
                    ...
                    if($status==0)
                    {
                      echo '<div class="alert alert-danger bg-danger text-white"> Email and password Invalid!</div>';
                    }
